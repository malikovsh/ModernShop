...
export const MassageIcon = () => {
    return (
        ...
        >
            <Path
                d="M8.395 15.239C12.077 15.03 15 11.925 15 8.125 15 4.19 11.866 1 8 1S1 4.19 1 8.125c0 1.402.398 2.71 1.085 3.812l-.495 1.51v.003c-.19.578-.285.868-.217 1.06.058.168.189.3.354.36.189.069.47-.027 1.036-.219l.008-.002 1.484-.504a6.877 6.877 0 004.14 1.094zm0 0s0 0 0 0zm0 0C9.353 18.012 11.948 20 15 20a6.878 6.878 0 003.744-1.105l1.485.504h.003c.568.193.853.29 1.042.221a.587.587 0 00.353-.36c.067-.193-.027-.483-.217-1.063l-.495-1.51.166-.28A7.189 7.189 0 0022 12.875c0-3.935-3.134-7.125-7-7.125l-.262.005-.132.006"
                stroke="#E4B717"
                strokeWidth={2}
                strokeLinecap="round"
                strokeLinejoin="round"
...
export const BasketWhiteIcon = () => {
    return (
        ...
        >
            <Path
                d="M1 1l1.71.311.791 9.916c.064.81.707 1.43 1.48 1.428h8.967c.737.002 1.363-.568 1.467-1.336l.78-5.668c.087-.633-.331-1.22-.933-1.312-.052-.008-12.278-.013-12.278-.013M10.35 7.52h2.28"
                stroke="#fff"
                strokeWidth={2}
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <Path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M4.62 15.651c.248 0 .447.211.447.47 0 .26-.2.472-.447.472a.46.46 0 01-.447-.471c0-.26.2-.47.447-.47zM13.893 15.651a.46.46 0 01.447.47c0 .26-.2.472-.447.472a.46.46 0 01-.448-.471c0-.26.2-.47.447-.47z"
                fill="#fff"
                stroke="#fff"
                strokeWidth={2}
                strokeLinecap="round"
